...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    first = 3 ** (player_score + opponent_score)
    end = first % 10
    while first >= 10:
        first = first // 10
    return first == end
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    pre_points0, pre_points1 = 0, 0 
    while score0 < goal and score1 < goal:
        if who == 0:
            num_rolls = strategy0(score0, score1)
            points = take_turn(num_rolls, score1, dice)
            score0 += points
            if feral_hogs and abs(pre_points0 - num_rolls) == 2:
                score0 += 3                
            pre_points0 = points 
        else:
            ...
            score1 += points
            if feral_hogs and abs(pre_points1 - num_rolls) == 2:
                score1 += 3 
            pre_points1 = points
